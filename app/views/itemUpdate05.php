...
<table class="mytable" width="100%" border="2" style="width:100%; color:rgba(0,0,0,1.00);">
   <tr>
   <td colspan="4" ><div class="displayhead"><?php echo $Name; ?> : Description<input type="hidden" name="ID" id="ID" value="<?php echo $ID; ?>"></div></td>
   </tr>
   <tr>
   <td colspan="4" >
...
<td style="float:right;"><input type="submit" name="OperationDescription" value="Update" class="btn btn-black btn-block" style="padding:20px;  width:250px;border-radius:0px; box-shadow:5px 5px rgba(110,110,110,0.69); "></td>
</tr>
</table>
</div>
</div>    
