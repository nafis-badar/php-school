...
<span style="margin-right:5px; border:0px;"  name="Operation"   class="btn btn-primary pull-right "onClick="redirectBypagewithIDValue('po',<?php echo $VoucherTypeID;?>,0);" >
	...
	?>
        ...
        foreach($query as $row)	{
            ?>
               ...
               onClick="redirectBypagewithIDValue('po',<?php echo $VoucherTypeID;?>,<?php echo $row['ID'];?>);" ></span>
