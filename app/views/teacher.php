...
<div class="workspace">
<div class="displayhead">Teacher Information
<span style=""  name="Operation"   class="btn btn-primary pull-right"  onClick="SaveTeacher();" >
...
if ($ID!=0)
{
	...
	$getinfo = $Handle->TeacherDetails($ID);
...
<div class="form-group">
 ...
 <div class="form-group">
 <label class="control-label" for="IsMaster" style="font-weight:bold;">Teacher Type:</label>
  <div class="">
  <select class="form-control" id="IsMaster"  name="IsMaster" style="font-size:22px!important; height:auto!important;" onBlur="SetMasterInfo(this.value);">
  	<option value="0" <?php if($IsMaster==0){echo 'selected="selected"';} ?>>Paid Teacher</option>
  </select>
 </div> </div> 
 ...
 <script type="text/javascript" src="app/libs/js/Teacher.js"></script>
    </div>
