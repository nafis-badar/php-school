...
if($ID!=0)
{
	...
	//echo $sql;
$getinfo = $Handle->CustomerDetails($ID);
...
function SaveCustomer0()
{
 ...
 {
	 	var pg='app/controllers/Save.Customer.php';
		 //alert(MasterID);
	 var Type='SaveCustomer';
	 var Name = $("#Name").val();
	 var MID = $("#MID").val();
