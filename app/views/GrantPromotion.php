...
<caption style="font-size:20px;">Promotion</caption>
	<tr>
    	<th>Academic Year</th><th>Class</th><th>Section</th><th>Roll No</th><th>Amount</th><th>...</th>
    </tr>
     <tr>
    <td>
...
for ($ig = 0; $ig < count($getSecinfo,0); $ig++) {
    ...
    <td>
    	<div class="btn " onClick="SetClass(<?php echo $ID; ?>);">Promote</div>
    </td>
    </tr>
    <?php
	...
	where StudentID=$ID order by AcademicYear Desc";
	//echo $sql;
