...
onClick="redirectBypagewithIDValue('payroll',1,<?php echo $PayrollID; ?>);" >
...
<div style="width:350px" align="center">
 ...
 <div class="upload_button">
  <input type="hidden" id="PayrollDetailsID" name="PayrollDetailsID" value="<?php echo $PayrollDetailsID;?>">
	   ...
	   e.preventDefault();
            ...
            success: function(msg){
                ...
                if(msg == " ok"){
					...
					//UpdateFileStatus($("#PayrollDetailsID").val());
				 $('#fupForm')[0].reset();
				$('.statusMsg').html('<span style="font-size:18px;color:#34A853">Err1Form Uploaded successfully.</span>');
                }
				else
				{
					//alert("A"+msg+"A");
                    $('.statusMsg').html('<span style="font-size:18px;color:#EA4335">Err2Some problem occurred, please try again.</span>');
                }
