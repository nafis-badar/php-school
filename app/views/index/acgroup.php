...
?>
<div class="workspace">
<div class="displayhead">Account Group Index
...
<span style="margin-right:5px;"  name="Operation"   class="btn btn-primary pull-right "onClick="redirectBypagewithIDValue('acgroup',0,0);" >
...
<i class="glyphicon glyphicon-book   " aria-hidden="true"></i> New</span>
  ...
  <tr style="border-bottom:2px double rgba(111,111,111,0.70);">
  	<th>CODE</th><th>Name</th>	<th>Under</th>	<th>Nature</th>	<th style="text-align:right;">...</th>
  </tr>
<?php

$getinfo = $Handle->getAcGroupIndex();
...
for ($x = 0; $x < count($getinfo,0); $x++) {
  ...
  <tr>
    ...
    <td style="text-align:right;"><span class="btn btn-primary" onClick="redirectBypagewithIDValue('acgroup',1,<?php echo $getinfo[$x]["ID"]; ?>)">Open</span></td>
  </tr>
