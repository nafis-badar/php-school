...
?>
<div class="workspace">
<div class="displayhead">Ledger Index
...
<span style="margin-right:5px;"  name="Operation"   class="btn btn-primary pull-right "onClick="redirectBypagewithIDValue('ledger',0,0);" >
...
?>
  <tr>
    ...
    <td style="text-align:right;"><span class="btn btn-primary" onClick="redirectBypagewithIDValue('ledger',1,<?php echo $getinfo[$x]["ID"]; ?>)">Open</span></td>
  </tr>
