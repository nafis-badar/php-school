...
<form class="form-horizontal" name="myform" id ="myform" method="post" role="form" action="app/models/product.sql.php" style="padding:15px">
<?php
$x=0;
$ID=0;
$ID=$_REQUEST['ID'];
...
<table class="mytable" width="100%" border="2" style="width:100%; color:rgba(0,0,0,1.00);">
   <tr>
   <td colspan="4" ><div class="displayhead"><?php echo $Name; ?> : Type Configuration<input type="hidden" name="ID" id="ID" value="<?php echo $ID; ?>"></div></td>
   </tr>
   <tr>
   <td>IsFinishGoods ?
		<select name="IsFinishGoods" id="IsFinishGoods" class="form-control input-sm">
            <option value="1" <?php if($IsFinishGoods=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsFinishGoods=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select>  </td>
   <td>IsRawMaterial ?
		<select name="IsRawMaterial" id="IsRawMaterial" class="form-control input-sm">
            <option value="1"  <?php if($IsRawMaterial=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsRawMaterial=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>
   <td>IsUnFinishGoods ?
		<select name="IsUnFinishGoods" id="IsUnFinishGoods" class="form-control input-sm">
            <option value="1"  <?php if($IsUnFinishGoods=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsUnFinishGoods=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>
   <td>IsFinancialItem ?
		<select name="IsFinancialItem" id="IsFinancialItem" class="form-control input-sm">
           <option value="1"  <?php if($IsFinancialItem=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsFinancialItem=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>
   </tr>
   <tr>
   <td colspan="4">&nbsp; </td>
   ...
   <td>IsStockItem ?
		<select name="IsStockItem" id="IsStockItem" class="form-control input-sm">
           <option value="1"  <?php if($IsStockItem=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsStockItem=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select>  </td>
    <td>IsNonStockItem ?
		<select name="IsNonStockItem" id="IsNonStockItem" class="form-control input-sm">
            <option value="1"  <?php if($IsNonStockItem=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsNonStockItem=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>    
    <td>IsNegetiveSalesAllow ?
		<select name="IsNegetiveSalesAllow" id="IsNegetiveSalesAllow" class="form-control input-sm">
            <option value="1"  <?php if($IsNegetiveSalesAllow=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsNegetiveSalesAllow=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>    
    <td>IsSalesAsNewManufacture ?
		<select name="IsSalesAsNewManufacture" id="IsSalesAsNewManufacture" class="form-control input-sm">
           <option value="1"  <?php if($IsSalesAsNewManufacture=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsSalesAsNewManufacture=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>    
   </tr>
    <tr>
   <td colspan="4">&nbsp; </td>
   ...
   <tr>
   <td>IsAsConsumed ?
		<select name="IsAsConsumed" id="IsAsConsumed" class="form-control input-sm">
         <option value="1"  <?php if($IsAsConsumed=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsAsConsumed=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>
   <td>IsRejectionAsScrap ?
		<select name="IsRejectionAsScrap" id="IsRejectionAsScrap" class="form-control input-sm">
         <option value="1"  <?php if($IsRejectionAsScrap=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($IsRejectionAsScrap=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>
   <td>Maintain Batch ?
		<select name="MaintainBatch" id="MaintainBatch" class="form-control input-sm">
         <option value="1"  <?php if($MaintainBatch=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($MaintainBatch=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>
   <td>Maintain Serial ?
		<select name="MaintainSerial" id="MaintainSerial" class="form-control input-sm">
         <option value="1"  <?php if($MaintainSerial=="1") echo 'selected= "selected"'; ?>>YES</option>
            <option value="0"  <?php if($MaintainSerial=="0") echo 'selected= "selected"'; ?>>NO</option>
		</select> </td>
   </tr>
 </table>
...
<tr>
<td style="float:left; "><input type="button" name="back" value="Back" onClick="closeModal();" class="btn   btn-black btn-block" style="padding:20px; width:250px; border-radius:0px;box-shadow:5px 5px rgba(110,110,110,0.69);  "></td>

<td style="float:right;"><input type="submit" name="Operation01" value="Update" class="btn btn-black btn-block" style="padding:20px;  width:250px;border-radius:0px; box-shadow:5px 5px rgba(110,110,110,0.69); "></td>
</tr>
</table>
</div>
</div>    
