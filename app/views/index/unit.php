...
<div class="workspace">
<div class="displayhead">Unit Index
...
<span style="margin-right:5px;"  name="Operation"   class="btn btn-primary pull-right "onClick="redirectBypagewithIDValue('unit',0,0);" >
...
<?php
$Handle = new Item();
$getinfo = $Handle->runQuery("SELECT * FROM tbl_unit");/* WHERE MasterTypeID=1");*/
...
for ($x = 0; $x < count($getinfo,0); $x++) {
   ...
   <div class="panel panel-default">
    <div class="panel-heading">
      <a href="#" onClick="redirectBypagewithIDValue('unit',1,<?php echo $getinfo[$x]["ID"]; ?>)">
