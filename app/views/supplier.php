...
if($ID!=0)
{
	...
	//echo $sql;
$getinfo = $Handle->SupplierDetails($ID);
...
function SaveSupplier0()
{
	var pg="app/controllers/Accounts.php";
	var Type="SaveSupplier";
 ...
 {
	 	var pg='app/controllers/Save.Supplier.php';
		 //alert(MasterID);
	 var Type='SaveSupplier';
	 var Name = $("#Name").val();
	 var MID = $("#MID").val();
	...
	var DrCr = document.getElementById("DrCr").value;
                $.post( pg, 
				{Type:Type,MasterTypeID:MasterTypeID, ID:ID, MID:MID, PDID:PDID, Name:Name, AddressID:AddressID, 
				ContactNo: ContactNo, Address: Address, RegDate: RegDate, 
				Email: Email, State: State, Country:Country, IsMaster:IsMaster,MasterGroupID:MasterGroupID,DrCr:DrCr})
                    .done(function( data ) {
						document.getElementById("Report").innerHTML=data;
                        //$("#message").html(data);
