...
function CreateCart($VoucherTypeID_V)
{
	$ID='0';
	$OfficeID='0';
	$CreatedBy='';
...
$EffectInventoryValue=$VoucherTypeInfo[0]['IsEffectPayrollValue'];
...
$CartTypeID=$VoucherTypeInfo[0]['CartTypeID'];
}
	$CartDate=date("Y-m-d"); 
	$ModifyTime=date("Y-m-d H:i:s"); 
	$ModifiedBy=$_SESSION['UserID'];
	...
	$CartID=$this->CartInsert($ID, $OfficeID, $CreatedBy, $CreateTime, $ModifiedBy, $ModifyTime, $TransactionID, $CartDate, $InventoryNature, $EffectInventoryValue, $VoucherID, $VoucherDetailsID, $CartTypeID,$ItemPriceTypeID);
	return $CartID;
...
if($IsOptional==1){$DocumentNo=$Alias.$NO.'-NEW[ OPT ]';}
...
if ($CartDetailsID>0)
{
	...
	$TaxClassID=$CartDetails[0]['TaxClassID'];
 	...
 	?>
    	 ...
    	 <tr style="padding:1px;">
            <td style="border-right:3px double rgba(215,106,108,1.00);border-left:3px solid rgba(235,106,108,1.00); ">
                ...
                <input type ="hidden" name="TaxClassID" id="TaxClassID" value="<?php echo $TaxClassID;?>" >
            </td>
            ...
            <input type="text"    id="U" value="" style="text-align:center; border:0px; background-color:rgba(255,255,255,1.00); " disabled> 
            </td>
        	<td style="">
            <div    style=" padding:0px 3px; text-align:left " > 
            
                	<input type="text"  onKeyPress="return isNumberKey(event)"  class="form-control" id="BillingQuantity"
                     value="<?php echo $BillingQuantity;?>"  
                    	style="text-align:center;" 
                       onChange	="calculate_item();" onKeyUp="ChangeDisplayQuantity(this.value);" > 
              ...
              <td style="">
                <div    style=" padding:0px 3px; text-align:left; display:inline; " >  
                	<input type="text" onKeyPress="return isNumberKey(event)" class="form-control rs" id="MRP" value="<?php echo $MRP;?>"   
            ...
            <td style="">
                <div    style=" padding:0px 3px; text-align:left; display:inline; " >  
                	<input type="text" onKeyPress="return isNumberKey(event)" class="form-control rs" id="ItemCost" value="<?php echo $ItemCost;?>"   
                            onChange="calculate_item();" onKeyUp="ChangeDisplayItemCost(this.value);"  style="text-align:right;">  
            ...
            <td style="">
            	<div    style=" padding:0px 3px; text-align:left " >  
                	<input type="text" onKeyPress="return isNumberKey(event)"  class="form-control rs" id="DiscountPercentage" value="<?php echo $DiscountPercentage;?>"   
                           onChange="calculate_item();" onKeyUp="calculate_item();"  style="text-align:right;">
             ...
             <td style="">
            	<div    style=" padding:0px 3px; text-align:left " >  
                	<input type="text" onKeyPress="return isNumberKey(event)"  class="form-control rs" id="CGSTPercentage" value="<?php echo $CGSTPercentage;?>"   
                           onChange="calculate_item();" onKeyUp="calculate_item();" style="text-align:right; background-color:rgba(255,255,255,1.00); border:none;" disabled>
                      
                </div>
            </td>
            <td style="">
            	<div    style=" padding:0px 3px; text-align:left " >  
                	<input type="text" onKeyPress="return isNumberKey(event)"  class="form-control rs" id="SGSTPercentage" value="<?php echo $SGSTPercentage;?>"   
                           onChange="calculate_item();" onKeyUp="calculate_item();" style="text-align:right; background-color:rgba(255,255,255,1.00); border:none;" disabled>
