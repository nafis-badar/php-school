...
//alert(VoucherTypeID);
var Type="StockRegister";
 var pg="app/views/stockregister.sql.php";
	$.post(pg,{Type:Type, FromDate:FromDate,ToDate:ToDate,searchcontent:searchcontent},function(data){
