...
<table class="mytable" width="100%" border="2" style="width:100%; color:rgba(0,0,0,1.00);">
    <tr>
   <td colspan="7"><div class="displayhead"><?php echo $Name; ?> : DUTIES & TAX(Sales//Inventory) Configuration</div></td>
   </tr>
 <tr>
 <td>Voucher</td> <td>Tax Ledger Name</td><td>Percentage</td><td>Rounding Method</td><td>Rounding Limit</td><td>Type</td><td>Action</td>
 </tr>
...
<?php
$getaccountinfo = $db_handle->runQuery("SELECT * FROM tbl_master where MID in (114)");
// echo $getaccountinfo [0]['Unit'];
...
<input type="text" class="form-control input-sm" name="RoundingLimit" id="RoundingLimit" placeholder="Enter Rounding Limit" value="0"> 
 ...
 <td>
 <input  type="submit" name="OperationItemTaxADD" value="SET" class="btn btn-black btn-block" style="padding:5px;  width:50px;border-radius:0px; box-shadow:5px 5px rgba(110,110,110,0.69); "></td>
<td></td>
</tr>
</table>
