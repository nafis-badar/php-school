...
?>
<div class="workspace">
<div class="displayhead">Customer Index
...
<span style="margin-right:5px;"  name="Operation"   class="btn btn-primary pull-right "onClick="redirectBypagewithIDValue('customer',0,0);" >
...
<?php
$getinfo = $Handle->getCustomerIndex();
...
?>
  <tr>
    ...
    <td style="text-align:right;"><span class="btn btn-primary" onClick="redirectBypagewithIDValue('customer',1,<?php echo $getinfo[$x]["ID"]; ?>)">Open</span></td>
  </tr>
