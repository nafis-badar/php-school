...
appearance: none;" name="PayrollPeriodID" id="PayrollPeriodID" disabled>
 ...
 <th>Employee : </th>
 <th  >
 <select style="width:100%; border:0px!important;" name="PayrollPeriodID" id="MasterID" onChange="getEmployee(this.value);">
